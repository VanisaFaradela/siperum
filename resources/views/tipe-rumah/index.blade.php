...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    @if(isset($cluster))
        <a href="{{ route('cluster.show', $cluster->slug) }}" class="btn btn-outline-secondary">
        ...
        <table class="table table-cluster table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('cluster.show', $item->cluster->slug ?? '#') }}" class="text-decoration-none">
                ...
                <tr>
                    <td colspan="11" class="text-center py-5">
                        ...
                        @if(isset($cluster))
                            <a href="{{ route('tipe-rumah.create', ['cluster_id' => $cluster->id]) }}" class="btn btn-green btn-sm mt-2">
